...
class DataBowl3Detector(Dataset):
    def __init__(self, data_dir, idcs, config, phase = 'train',split_comber=None):
        ...
        self.filenames = [os.path.join(data_dir, '%s_clean.npy' % idx) for idx in idcs if os.path.isfile(os.path.join(data_dir, '%s_clean.npy' % idx))]
