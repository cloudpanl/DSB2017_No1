...
class DataBowl3Classifier(Dataset):
    """Get top 5(configurable) nodules for testing or sample 5(configurable) nodules for training C-Net.    
    """
    ...
    def __init__(self, split, config, phase = 'train'):
        ...
        Arguments:
            split {list} -- a list of patient ids.
            config {dict} -- config dict.
        
        Keyword Arguments:
            phase {str} -- 'train', 'test' or 'val'. (default: {'train'})
        """
